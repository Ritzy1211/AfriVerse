...
const countryDataMap: Record<string, CountryPulse> = {
  ng: {
    ...
    topStoryUrl: '/search?q=Nigerian+tech+startups',
  ...
  za: {
    ...
    topStoryUrl: '/search?q=South+Africa+energy+crisis',
  ...
  eg: {
    ...
    topStoryUrl: '/search?q=Cairo+Tech+Week',
  ...
  et: {
    ...
    topStoryUrl: '/search?q=Ethiopia+telecom+investment',
  ...
  rw: {
    ...
    topStoryUrl: '/search?q=Kigali+Innovation+City',
  ...
  tz: {
    ...
    topStoryUrl: '/search?q=Tanzania+tourism+growth',
