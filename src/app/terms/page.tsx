      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto prose prose-lg dark:prose-invert">
            ...
            <ul>
              <li><strong>Email:</strong> <a href="mailto:tips@afriverse.africa">tips@afriverse.africa</a></li>
              <li><strong>Address:</strong> 7 Veritas Street, Maitama, Abuja, Nigeria</li>
            </ul>

            <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-6 mt-8">
              <h3 className="mt-0">Summary</h3>
              <p className="mb-0">
                Respect our content and community. Don't copy or redistribute our articles without permission. Be civil in comments. We provide content "as is" without guarantees. For questions, email <a href="mailto:tips@afriverse.africa">tips@afriverse.africa</a>.
              </p>
            </div>
          </div>
        </div>
